...
public class Case4_PreyPredator {
    ...
    public static void runCase() {
        ...
        while(true) {
            ...
            final double rabbitsNp1_EE = rabbitsN_EE + timeStep * (rabbitMating*rabbitsN_EE - rabbitPreyed*rabbitsN_EE*foxesN_EE);
            final double foxesNp1_EE = foxesN_EE + timeStep * (-foxesStarvation*foxesN_EE + foxesPreying*rabbitsN_EE*foxesN_EE);
            //Euler Implicit time-integration
            final double rabbitsNp1_EI = rabbitsN_EI + timeStep * (rabbitMating*rabbitsN_EI - rabbitPreyed*rabbitsN_EI*foxesN_EI);
            final double foxesNp1_EI = foxesN_EI + timeStep * (-foxesStarvation*foxesN_EI + foxesPreying*rabbitsN_EI*foxesN_EI);
            // Runge-Kutta 2 Midpoint time-integration
            final double htMid = 0.5 * timeStep;
            final double rabbitsMid = rabbitsN_RK2 + htMid * (rabbitMating*rabbitsN_RK2 - rabbitPreyed*rabbitsN_RK2*foxesN_RK2);
            final double foxesMid = foxesN_RK2 + htMid * (-foxesStarvation*foxesN_RK2 + foxesPreying*rabbitsN_RK2*foxesN_RK2);
            final double rabbitsNp1_RK2 = rabbitsN_RK2 + timeStep * (rabbitMating*rabbitsMid - rabbitPreyed*rabbitsMid*foxesMid);
            final double foxesNp1_RK2 = foxesN_RK2 + timeStep * (-foxesStarvation*foxesMid + foxesPreying*rabbitsMid*foxesMid);
